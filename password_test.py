...
class TestClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_password = Credentials(
            "maxwelljr", "gmail.com", "2020")  # create password object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_password.username, "maxwelljr")
    ...
    def test_save_multiple_passwords(self):
        ...
        test_password = Credentials(
            "willen", "instagram.com", "2000")  # new password account
    ...
    def test_delete_password(self):
        ...
        test_password = Credentials("verah", "facebook.com", "@1990")
        test_password.save_password()
    ...
    def test_find_password_by_website(self):
        ...
        '''
        self.new_password.save_password()
        test_password = Credentials("aria", "snapchat.com", "@1991")
        test_password.save_password()

        found_password = Credentials.find_by_website("snapchat.com")
